...
if __name__ == "__main__":
    ...
    parser.add_argument('-s','--starting_run', type=int, default=1, help="Run number to start from (use if existing data for experiment)")
    ...
    parser.add_argument('-p','--physics_cache', action='store_true', help = "Use existing physics cache")
