...
from General.Utils import readFromJson, writeToJson, countFileLines, readFirstJson, save_json, QD_Analytics
...
def main(argv):
    ...
    # single_objective_dict.add_objective(name="selectionFitness", maximize=True, tag="<NormFinalDist>")
    ...
    if runsSoFar > 0:
        ...
        firstRun = int(firstRun[0]) + runsSoFar - 1
    else:
