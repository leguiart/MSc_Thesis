...
class QualitySoftbotProblem(BaseSoftbotProblem):
    ...
    def __init__(self, physics_evaluator : BasePhysicsEvaluator, pop_size):
        ...
        self.evaluators["unaligned_novelty"] = NoveltyEvaluator(unaligned_distance_metric, "unaligned_novelty", is_valid_func=is_valid_func, min_novelty_archive_size=pop_size//2, max_novelty_archive_size=MAX_NS_ARCHIVE_SIZE, k_neighbors=20)
