...
class QualitySoftbotProblem(BaseSoftbotProblem):
    ...
    def __init__(self, physics_evaluator : BasePhysicsEvaluator, pop_size):
        ...
        self.evaluators["unaligned_novelty"] = NoveltyEvaluator(unaligned_distance_metric, "unaligned_novelty", is_valid_func=is_valid_func, min_novelty_archive_size=pop_size, max_novelty_archive_size=MAX_NS_ARCHIVE_SIZE)
...
class MNSLCSoftbotProblem(BaseSoftbotProblem):
    ...
    def __init__(self, physics_evaluator : BasePhysicsEvaluator, pop_size):
        ...
        self.evaluators.update({"aligned_novelty" : NoveltyEvaluator(aligned_distance_metric, "aligned_novelty", is_valid_func=is_valid_func, min_novelty_archive_size=pop_size, max_novelty_archive_size=MAX_NS_ARCHIVE_SIZE), 
                            "unaligned_novelty" : NoveltyEvaluator(unaligned_distance_metric, "unaligned_novelty", nslc_neighbors_name="unaligned_neighbors", is_valid_func=is_valid_func, min_novelty_archive_size=pop_size, max_novelty_archive_size=MAX_NS_ARCHIVE_SIZE),
