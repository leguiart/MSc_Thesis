        ...
        if ls_check:
            ...
            if "softbotsOutput--id_" in ls_check:
                ...
                if this_id in already_analyzed_ids:
                    ...
                    objective_values_dict = read_voxlyze_results(pop.objective_dict, print_log, ind_filename)
...
#def evaluate_all_pymoo(sim, env, pop, print_log, save_vxa_every, run_directory, run_name, already_evaluated, all_evaluated_individuals_ids, worst_value, max_eval_time=60,
#                 time_to_try_again=10, save_lineages=False):